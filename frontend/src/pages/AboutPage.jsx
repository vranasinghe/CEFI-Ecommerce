    ...
    <div className="space-y-20 pb-20">
      ...
      <section className="bg-cefi-cream py-16 border-y border-cefi-cream-dark/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Vision Card */}
            <div className="group bg-white hover:bg-cefi-green transition-colors duration-300 rounded-3xl p-8 border border-gray-100 shadow-soft space-y-4">
              <div className="w-12 h-12 bg-cefi-green/10 group-hover:bg-white/20 text-cefi-green group-hover:text-white transition-colors duration-300 rounded-2xl flex items-center justify-center">
            ...
            <div className="group bg-white hover:bg-cefi-green transition-colors duration-300 rounded-3xl p-8 border border-gray-100 shadow-soft space-y-4">
              ...
              <h3 className="font-serif font-bold text-2xl text-cefi-earth group-hover:text-white transition-colors duration-300">Our Mission</h3>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group bg-white hover:bg-cefi-green transition-colors duration-300 rounded-3xl p-6 border border-gray-100 shadow-soft space-y-3">
            <h3 className="font-serif font-bold text-xl text-cefi-green group-hover:text-white transition-colors duration-300">Pure Ceylon Tea</h3>
            <p className="text-xs text-gray-600 group-hover:text-emerald-50 transition-colors duration-300 leading-relaxed">
              Black, Green, White, and Herbal blended teas sourced from Nuwara Eliya, Dimbula, and Uva highlands.
            </p>
            <Link to="/products/tea" className="text-xs font-bold text-cefi-gold group-hover:text-white transition-colors duration-300 hover:underline inline-block pt-1">
              Browse Tea Category →
            </Link>
          </div>

          <div className="group bg-white hover:bg-cefi-green transition-colors duration-300 rounded-3xl p-6 border border-gray-100 shadow-soft space-y-3">
            <h3 className="font-serif font-bold text-xl text-cefi-green group-hover:text-white transition-colors duration-300">Ceylon Spices</h3>
            <p className="text-xs text-gray-600 group-hover:text-emerald-50 transition-colors duration-300 leading-relaxed">
              Alba-grade True Cinnamon quills, Tellicherry black pepper, emerald cardamom, cloves, and nutmeg.
            </p>
            <Link to="/products/spices" className="text-xs font-bold text-cefi-gold group-hover:text-white transition-colors duration-300 hover:underline inline-block pt-1">
              Browse Spice Category →
            </Link>
          </div>

          <div className="group bg-white hover:bg-cefi-green transition-colors duration-300 rounded-3xl p-6 border border-gray-100 shadow-soft space-y-3">
            <h3 className="font-serif font-bold text-xl text-cefi-green group-hover:text-white transition-colors duration-300">Herbal & Dried Fruits</h3>
            <p className="text-xs text-gray-600 group-hover:text-emerald-50 transition-colors duration-300 leading-relaxed">
              Gotu Kola, Moringa leaf powder, solar-dehydrated mango, pineapple, and young jackfruit.
            </p>
            <Link to="/products/herbal" className="text-xs font-bold text-cefi-gold group-hover:text-white transition-colors duration-300 hover:underline inline-block pt-1">
